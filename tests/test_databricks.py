...
class TestBuildOpencodeBaseUrls:
    ...
    def test_returns_native_openai_gateway(self):
        # @ai-sdk/openai appends /responses to the native model-service base.
        urls = build_opencode_base_urls(WS)
...
class TestGptModelTokenLimits:
    ...
    def test_grok46_uses_documented_500k_context(self):
...
class TestDiscoverModelServicesDynamicOss:
    ...
    def test_grok_stays_on_the_responses_route(self, monkeypatch):
        ...
        foundation_models = _mlflow_chat_payload(
            ["databricks-grok-4-6"], api_type="openai/v1/responses"
        )
